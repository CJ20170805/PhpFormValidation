...
function validate(e) {
	...
	// When using onSubmit="validate()" in markup, returning true will allow
	// the form to submit
	return true;
}
...
function addItemToCart(itemNumber) {
	...
	console.log('nm', itemNumber, quantityValue);
...
function load() {
	...
	document.getElementById('addMac').addEventListener('click', ()=>addItemToCart(1), false);
	document.getElementById('addMouse').addEventListener('click', ()=>addItemToCart(2), false);
	document.getElementById('addWD').addEventListener('click', ()=>addItemToCart(3), false);
	document.getElementById('addNexus').addEventListener('click', ()=>addItemToCart(4), false);
	document.getElementById('addDrums').addEventListener('click', ()=>addItemToCart(5), false);
